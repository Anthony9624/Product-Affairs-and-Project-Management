...
<body>
	<div class="x-body">
		<form class="layui-form" action="${pageContext.request.contextPath}/JiabanshenqingAdd" method="post">
			...
			<div class="layui-form-item">
				...
				%>
				<div class="layui-input-inline">
					<input class="layui-input" placeholder="申请时间" name="shenqingshijian" id="shenqingshijian" required="" lay-verify="required" value="<%=dateFormat.format(calendar.getTime()) %>" autocomplete="off" type="text">
				</div>
			</div>
			<div class="layui-form-item">
				<label class="layui-form-label">
				...
				<div class="layui-input-inline">
					<input class="layui-input" placeholder="加班时间" name="jiabanshijian" id="jiabanshijian" required="" lay-verify="required" autocomplete="off" type="text">
				</div>
			</div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" id="jiabanshichang" name="jiabanshichang" required="" lay-verify="required" autocomplete="off" class="layui-input">
				</div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<textarea type="readonly" id="yuanyin" name="yuanyin" required="" lay-verify="" autocomplete="off" class="layui-textarea"></textarea>
				</div>
			</div>
			<div class="layui-form-item">
				<label class="layui-form-label">
