...
<head>
<meta charset="UTF-8">
<title>欢迎使用项目与事务管理系统</title>
<title>Author：Anthony_Yu</title>
...
<body class="login-bg">
	<div class="login layui-anim layui-anim-up">
		<div class="message">欢迎使用项目与事务管理系统</div>
		<div id="darkbannerwrap"></div>
		<form method="post" class="layui-form" id="login-form" action="/ManageSystem/LoginServlet">
			...
			<div class="layui-form-item">
				<div class="layui-input-inline">
					<input type="text" name="check" lay-verify="check" placeholder="点击图片刷新验证码" autocomplete="off" class="input-val">
				</div>
	...
	<script>
			layui.use(['form', 'layer'], function() {
				...
				function draw(show_num) {
					...
					var sCode = "A,B,C,E,F,G,H,J,K,L,M,N,P,Q,R,S,T,U,V,W,X,Y,Z,1,2,3,4,5,6,7,8,9,0";
