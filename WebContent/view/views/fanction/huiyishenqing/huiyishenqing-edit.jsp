...
<body>
	<div class="x-body">
		<form class="layui-form" action="${pageContext.request.contextPath}/HuiyishenqingEdit" method="post">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input class="layui-input" placeholder="申请时间"value="<%=request.getParameter("shenqingshijian")%>" name="shenqingshijian" id="shenqingshijian" required="" lay-verify="required" autocomplete="off" type="text">
				</div>
			</div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input class="layui-input" placeholder="会议开始时间" name="begin" value="<%=request.getParameter("begin") %>" id="begin" required="" lay-verify="required" autocomplete="off"
						type="text">
				</div>
			</div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" id="huiyididian" name="huiyididian" value="<%=request.getParameter("huiyididian") %>" required="" lay-verify="huiyididian" autocomplete="off"
						class="layui-input">
				</div>
			</div>
