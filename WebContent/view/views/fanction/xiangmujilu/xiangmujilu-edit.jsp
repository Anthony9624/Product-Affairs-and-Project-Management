...
org.apache.commons.dbutils.handlers.ScalarHandler,org.apache.commons.dbutils.handlers.BeanListHandler,cn.managesystem.domain.Staff,cn.managesystem.domain.xiangmujilu"
	pageEncoding="utf-8"%>
...
<%
	...
	String sql2 = "select youxianji from xiangmujilu";
	QueryRunner qr2 = new QueryRunner(C3P0Utils.getDataSource());
	List<xiangmujilu> youxianji = qr2.query(sql2, new BeanListHandler<xiangmujilu>(xiangmujilu.class));
%>
<body>
	<div class="x-body">
		<form class="layui-form" action="${pageContext.request.contextPath}/xiangmujiluEdit" method="post">
			<div class="layui-form-item">
				<label class="layui-form-label">
					<span class="x-red">*</span>项目编号
				</label>
				<div class="layui-input-inline">
					<input type="text" id="id" name="id" required=""  readonly="readonly" value="<%=request.getParameter("id") %>" lay-verify="required" autocomplete="off" class="layui-input">
				</div>
			</div>
			<div class="layui-form-item">
				<label class="layui-form-label">
				...
				<div class="layui-input-block">
					<input class="layui-input" placeholder="项目开始时间" name="kaishishijian" id="kaishishijian" required="" lay-verify="required" value="<%=request.getParameter("kaishishijian")%>" autocomplete="off" type="text">
				</div>
			</div>
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<select name="jieduan" required="" lay-verify="required">
						<option class="layui-input" value="<%=request.getParameter("jieduan")%>" lay-skin="primary"><%=request.getParameter("jieduan")%></option>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" id="xiangmumingcheng" name="xiangmumingcheng" required="" value="<%=request.getParameter("xiangmumingcheng")%>" lay-verify="required" autocomplete="off" class="layui-input">
				</div>
			</div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<textarea type="text" id="shuoming" name="shuoming" required="" lay-verify="required" autocomplete="off" class="layui-textarea"><%=request.getParameter("shuoming")%></textarea>
				</div>
			</div>
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<select name="youxianji" required="" lay-verify="required">
						<option class="layui-input" value="<%=request.getParameter("youxianji")%>" lay-skin="primary"><%=request.getParameter("youxianji")%></option>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					...
					readonly="readonly" 
					value="<%=request.getParameter("jiluren")%>" lay-verify="required" autocomplete="off" class="layui-input">
				</div>
			</div>
			<div class="layui-form-item">
