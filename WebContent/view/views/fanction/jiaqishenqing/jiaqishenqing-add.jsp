...
cn.managesystem.domain.Jiaqishenqing,cn.managesystem.domain.Staff,java.text.SimpleDateFormat"
	pageEncoding="utf-8"%>
...
<body>
	<div class="x-body">
		<form class="layui-form" action="${pageContext.request.contextPath}/JiaqishenqingAdd" method="post">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input class="layui-input" placeholder="开始时间" value="<%=dateFormat.format(calendar.getTime()) %>" name="kaishishijian" id="kaishishijian" required="" lay-verify="required" autocomplete="off" type="text">
				</div>
			</div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input class="layui-input" placeholder="结束时间" name="jieshushijian" id="jieshushijian" required="" lay-verify="required" autocomplete="off" type="text">
				</div>
			</div>
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" id="day" name="day" required="" lay-verify="day" autocomplete="off" class="layui-input">
				</div>
			...
			<div class="layui-form-item">
				<label class="layui-form-label">
					<span class="x-red">*</span>详细原因
				</label>
				<div class="layui-input-block">
					<textarea type="text" id="yuanyin" name="yuanyin" required="" lay-verify="required" autocomplete="off" class="layui-textarea"></textarea>
				</div>
			</div>
			<div class="layui-form-item">
				<label class="layui-form-label">
				...
				<div class="layui-input-inline">
					<input type="text" name="zhuangtai" required="" lay-verify="required" class="layui-input" value="等待批准" readonly>
				</div>
			</div>
