...
<body>
	<div class="x-body">
		<form class="layui-form" action="${pageContext.request.contextPath}/XinxuqiuAdd" method="post">
			<div class="layui-form-item">
				<label class="layui-form-label">
					<span class="x-red">*</span>提出时间
				</label>
				<div class="layui-input-inline">
					<input class="layui-input" placeholder="提出时间" name="tichushijian" id="tichushijian" required="" lay-verify="required" autocomplete="off" type="text">
				</div>
			</div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" id="wanchengtianshu" name="
						wanchengtianshu" required="" lay-verify="wanchengtianshu" autocomplete="off"
						class="layui-input">
				</div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<%
						for (Staff s : staff) {
					%>
					<input type="checkbox" name="fuzeren" title="<%=s.getStaffname()%>"
						value="<%=s.getStaffname()%>">
					<%
						}
					%>
				</div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" id="zhixingzu" name="zhixingzu" required="" lay-verify="required" autocomplete="off" class="layui-input">
				</div>
			</div>
