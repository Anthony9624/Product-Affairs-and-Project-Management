...
<body>
	<div class="x-body">
		<form class="layui-form" action="${pageContext.request.contextPath}/JiabanshenqingEdit" method="post">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<select name="staffname" required="" lay-verify="required">
						<option class="layui-input" value="<%=request.getParameter("staffname") %>" 
					 lay-skin="primary"><%=request.getParameter("staffname") %></option>
						<%
							for (Staff s : staff) {
						%>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input class="layui-input" placeholder="申请时间" name="shenqingshijian" id="shenqingshijian" required="" lay-verify="required" value="<%=request.getParameter("shenqingshijian") %>" autocomplete="off" type="text">
				</div>
			</div>
			
			<div class="layui-form-item">
				<label class="layui-form-label">
					<span class="x-red">*</span>加班时间
				</label>
				<div class="layui-input-inline">
					<input class="layui-input" placeholder="加班时间" name="jiabanshijian" id="jiabanshijian" required="" lay-verify="required" value="<%=request.getParameter("jiabanshijian") %>" autocomplete="off" type="text">
				</div>
			</div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" id="jiabanshichang" name="jiabanshichang" required=""
					 value="<%=request.getParameter("jiabanshichang") %>" lay-verify="jiabanshichang" autocomplete="off" class="layui-input">
				</div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<textarea type="text" id="yuanyin" name="yuanyin" required="" lay-verify="required" autocomplete="off" class="layui-textarea"><%=request.getParameter("yuanyin") %></textarea>
				</div>
			</div>
			<div class="layui-form-item">
